      ...
      body: Stack(
        children: [
          ...
          Container(
            ...
            child: Text('Profile', style: TextStyle(fontFamily: 'Poppins', fontSize: 20, fontWeight: FontWeight.w600,)),
          ),
          Container(
            margin: const EdgeInsets.only(top: 165, left: 100),
            child: Text('Raquel Brummock', style: TextStyle(fontFamily: 'Poppins', fontSize: 21, fontWeight: FontWeight.bold,)),
          ),
          Container(
